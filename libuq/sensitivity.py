...
from libuq.aggregation import AggregatedOutput, AggregationStrategy
from libuq.inputs import XSpaceVecoli
from libuq.io import DataclassIO
from libuq.pce.models import Parameter
from libuq.wrappers import PrecomputedWrapper, SimulationWrapper, WrapperConfig

if TYPE_CHECKING:
    import polars as pl

    from libuq.cell_cycle import CellCycleVariable
...
def identify_cell_cycle_relevant_observables(
    ...
    """
    from libuq.aggregation import compute_variance_decomposition
