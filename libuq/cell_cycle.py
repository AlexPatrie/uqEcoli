...
if TYPE_CHECKING:
    ...
    from libuq.aggregation import AggregatedOutput
    from libuq.sensitivity import CellCycleRelevanceResult
...
class GSAInformedCellCycleVariable(CellCycleVariableComputer):
    ...
    Example:
        >>> from libuq import GSAInformedCellCycleVariable
        >>>
    ...
    def _run_gsa_selection(self) -> None:
        ...
        from libuq.sensitivity import identify_cell_cycle_relevant_observables
...
def calculate_cell_cycle(
    ...
    Example:
        >>> from libuq.cell_cycle import calculate_cell_cycle
        >>>
