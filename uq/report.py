...
<div class="header">
  ...
  <div class="subtitle">{html.escape(framework)} &mdash; {ts_display or "Generated " + datetime.now(tz=timezone.utc).strftime("%B %d, %Y")}</div>
</div>
...
<!-- Cross-strategy comparison -->
<div class="strategy-divider">Cross-Strategy Comparison</div>
...
<div class="section">
  ...
  <p class="section-desc">
    Side-by-side total Sobol indices. Differences indicate that parameter importance
    depends on how cells are grouped &mdash; a signal that population-level conclusions
    alone may miss important drivers.
  </p>
